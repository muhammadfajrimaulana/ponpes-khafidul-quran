...
<head>
    <meta charset="utf-8">
    <title>Madrasah Aliayah - Pondok Pesantren Modern Khafidul Quran</title>
...
<body style="background-color: #f8f9fa;">
    ...
    <div class="container-fluid" style="position: relative; background: linear-gradient(135deg, #00529c 0%, #003366 100%); min-height: 300px; display: flex; align-items: center; color: white; padding: 40px 0 90px 0;">
        <div class="container px-5 text-center text-lg-start">
            ...
            <h1 class="m-0 text-white" style="font-size: clamp(2rem, 5vw, 3rem); font-weight: 800; line-height: 1.2;">Madrasah Aliyah<br><span class="text-warning">(MA) Jatirejo</span></h1>
            <div class="mt-4" style="display: inline-flex; background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); padding: 8px 25px; border-radius: 50px; border: 1px solid rgba(255, 255, 255, 0.2); font-size: 0.9rem;">
                ...
                <span class="text-warning fw-bold">Madrasah Aliyah Jatirejo</span>
            </div>
        </div>
    </div>
    ...
    <section style="padding: 60px 0; background-color: #f0f9ff; margin-top: -40px; position: relative; z-index: 5;">
        <div class="container px-4">
            <div class="row g-5">
                ...
                <div class="col-lg-8">
                    <span class="text-primary fw-bold text-uppercase small" style="letter-spacing: 1px;">Jenjang Pendidikan</span>
                    <h2 class="fw-bold mb-4" style="color: #2d3436; font-weight: 800;">Madrasah Aliyah Jatirejo</h2>
                    <div class="text-muted mb-5" style="line-height: 1.9; text-align: justify;">
                        <p>Madrasah Aliyah Jatirejo lahir ...</p>
                        <p>Secara forma...</p>
                ...
                <div class="col-12">
                    ...
                    <div class="tab-content bg-white p-4 border shadow-sm" style="border-radius: 20px;">
                        <div class="tab-pane fade show active" id="visi">
                            ...
                            <p class="font-italic text-secondary border-start border-warning border-4 ps-3">"Menjadi Program Studi Pendidikan Agama Islam yang unggul dalam pengembangan keilmuan dan praktik pendidikan Islam berbasis moderasi beragama, teknologi pendidikan, dan kearifan lokal Banten pada tahun 2036."</p>
    ...
    <section class="py-5 bg-white">
        <div class="container text-center px-4">
            <h3 class="fw-bold mb-5" style="font-weight: 800;">Keunggulan <span class="text-primary">Madrasah Aliyah Jatirejo</span></h3>
            <div class="row g-4">
                <div class="col-md-4">
