...
<body style="background-color: #f8f9fa;">
    ...
    <div class="container-fluid" style="position: relative; background: linear-gradient(135deg, #004b87 0%, #003366 100%); min-height: 300px; display: flex; align-items: center; color: white; padding: 40px 0 90px 0;">
        <div class="container px-5 text-center text-lg-start">
            <h1 class="m-0 text-white" style="font-size: clamp(2rem, 5vw, 3rem); font-weight: 800; line-height: 1.2;">Data <br><span class="text-warning">& Profil Alumni</span></h1>
    ...
    <div class="container mb-5">
        <div class="shadow-sm" style="background: #fff; padding: 50px 35px; border-radius: 24px; margin-top: -40px; position: relative; z-index: 5;">
            ...
            <div class="row g-3 mb-5 justify-content-center p-4 bg-light border-0" style="border-radius: 16px;">
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="text" class="form-control shadow-none" placeholder="Cari nama Alumni...">
            ...
            <div class="text-center text-lg-start mb-4">
                <span class="text-primary fw-bold text-uppercase small" style="letter-spacing: 1px;">Daftar Alumni Ponpes</span>
            </div>
            ...
            <div class="row g-4 justify-content-center">
                    ...
                    <div class="card-alumni">
                        <div style="height: 120px; background: linear-gradient(to right, #004b87 0%, #003366 100%); position: relative;">
                            <div style="position: absolute; bottom: -50px; left: 50%; transform: translateX(-50%); z-index: 2;">
                                <img src="https://via.placeholder.com/150x200" alt="Muhammad Al-Fatih" style="width: 110px; height: 110px; border-radius: 50%; border: 5px solid #fff; object-fit: cover; background: #f8f9fa; box-shadow: 0 5px 15px rgba(0,0,0,0.15);">
                            </div>
                        </div>
                        <div style="padding: 70px 20px 35px 20px;">
                            <h5 style="font-weight: 800; font-size: 1.1rem; color: #003366; margin-bottom: 5px; text-transform: uppercase;">MUHAMMAD AL-FATIH</h5>
                            <p style="font-size: 0.9rem; color: #666; margin-bottom: 25px; min-height: 25px;">Angkatan 2024</p>
                            <button data-bs-toggle="modal" data-bs-target="#modalAlumni1" class="btn btn-sm btn-outline-primary px-4 rounded-pill fw-bold" style="font-size: 0.8rem;">Lihat Detail</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card-alumni">
                        <div style="height: 120px; background: linear-gradient(to right, #004b87 0%, #003366 100%); position: relative;">
                            <div style="position: absolute; bottom: -50px; left: 50%; transform: translateX(-50%); z-index: 2;">
                                <img src="https://via.placeholder.com/150x200" alt="Annisa Rahmawati" style="width: 110px; height: 110px; border-radius: 50%; border: 5px solid #fff; object-fit: cover; background: #f8f9fa; box-shadow: 0 5px 15px rgba(0,0,0,0.15);">
                            </div>
                        </div>
                        <div style="padding: 70px 20px 35px 20px;">
                            <h5 style="font-weight: 800; font-size: 1.1rem; color: #003366; margin-bottom: 5px; text-transform: uppercase;">ANNISA RAHMAWATI</h5>
                            <p style="font-size: 0.9rem; color: #666; margin-bottom: 25px; min-height: 25px;">Angkatan 2023</p>
                            <button data-bs-toggle="modal" data-bs-target="#modalAlumni2" class="btn btn-sm btn-outline-primary px-4 rounded-pill fw-bold" style="font-size: 0.8rem;">Lihat Detail</button>
                        </div>
                    </div>
                </div>
    ...
    <!-- MODAL POPUP ALUMNI 1 -->
    <div class="modal fade" id="modalAlumni1" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 16px; border: none; overflow: hidden;">
                <div class="modal-header text-white" style="background: linear-gradient(135deg, #004b87, #003366); border: none;">
                    <h5 class="modal-title fw-bold text-white text-uppercase" style="font-size: 0.9rem; letter-spacing: 0.5px;"><i class="fas fa-user-circle me-2"></i>Detail Profil Alumni</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4 text-start">
                    <div class="text-center mb-4">
                        <img src="https://via.placeholder.com/150x200" alt="Muhammad Al-Fatih" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid #004b87; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                        <h4 class="fw-bold mt-2 mb-0" style="color: #004b87; font-size: 1.25rem;">MUHAMMAD AL-FATIH</h4>
                        <span class="badge bg-success px-3 py-2 rounded-pill mt-1" style="font-size: 0.75rem;">Kuliah</span>
                    </div>
                    <table class="table table-striped table-bordered m-0" style="font-size: 0.9rem;">
                        <tbody>
                            <tr><th style="width: 38%; color: #003366;"><i class="fas fa-graduation-cap text-primary me-2"></i>Tahun Lulus</th><td>2024</td></tr>
                            <tr><th style="color: #003366;"><i class="fas fa-university text-primary me-2"></i>Kampus / Instansi</th><td>UIN Syarif Hidayatullah</td></tr>
                            <tr><th style="color: #003366;"><i class="fas fa-map-marker-alt text-primary me-2"></i>Lembaga Asal</th><td>Pondok Pesantren Modern</td></tr>
                        </tbody>
                    </table>
                </div>
    ...
    <!-- MODAL POPUP ALUMNI 2 -->
    <div class="modal fade" id="modalAlumni2" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 16px; border: none; overflow: hidden;">
                <div class="modal-header text-white" style="background: linear-gradient(135deg, #004b87, #003366); border: none;">
                    <h5 class="modal-title fw-bold text-white text-uppercase" style="font-size: 0.9rem; letter-spacing: 0.5px;"><i class="fas fa-user-circle me-2"></i>Detail Profil Alumni</h5>
                ...
                <div class="modal-body p-4 text-start">
                    <div class="text-center mb-4">
                        <img src="https://via.placeholder.com/150x200" alt="Annisa Rahmawati" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid #004b87; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
                        <h4 class="fw-bold mt-2 mb-0" style="color: #004b87; font-size: 1.25rem;">ANNISA RAHMAWATI</h4>
                        <span class="badge bg-success px-3 py-2 rounded-pill mt-1" style="font-size: 0.75rem;">Kuliah (Luar Negeri)</span>
                    </div>
                    <table class="table table-striped table-bordered m-0" style="font-size: 0.9rem;">
                        <tbody>
                            <tr><th style="width: 38%; color: #003366;"><i class="fas fa-graduation-cap text-primary me-2"></i>Tahun Lulus</th><td>2023</td></tr>
                            <tr><th style="color: #003366;"><i class="fas fa-university text-primary me-2"></i>Kampus / Instansi</th><td>Universitas Al-Azhar Kairo</td></tr>
                            <tr><th style="color: #003366;"><i class="fas fa-map-marker-alt text-primary me-2"></i>Lembaga Asal</th><td>Pondok Pesantren Modern</td></tr>
                        </tbody>
                    </table>
                </div>
